...
var zoom_scenes := {
	...
	"dining_room_floral_reliquary_open_with_spiral_medallion_far": preload("res://scenes/zooms/dining_room/zoom_floral_reliquary_open_with_spiral_medallion_far.tscn"),
